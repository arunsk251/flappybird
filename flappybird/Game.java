...
public class Game extends JPanel implements ActionListener, KeyListener {
    ...
    public Game(int velocityX) {
        this.velocityX = velocityX; // Set the velocity from the constructor
    ...
    public void move() {
        ...
        if (player.y > boardHeight) { // Bird hits the ground
            endGame(); // Call endGame when bird hits the ground
        }
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.drawString("Press R to Restart", boardWidth / 2 - 50, boardHeight / 2 + 20);
    ...
    private void endGame() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            System.exit(0); // Exit the application if user chooses not to restart
        }
    }
